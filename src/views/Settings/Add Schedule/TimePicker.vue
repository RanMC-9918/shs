  ...
  <confirm-popup :show="show" ok-text="Select" @cancel="cancel" @ok="done">
    <div class="time-picker">
      <div class="time-selector">
        ...
        <scroll-selector v-model="selectedTime.minute" :options="minutes" font-size="1.5em" :infinite="true" />
        <scroll-selector v-model="selectedTime.suffix" :options="suffixes" font-size="1.5em" :infinite="true" />
      </div>
