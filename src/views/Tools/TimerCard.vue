    ...
    <div ref="fullscreen-wrapper" class="fullscreen-wrapper">
      ...
      <div class="container">
        <div class="time-selector">
          <scroll-selector ref="scroll-selector-1" :infinite="true" v-model="time.hours" :options="hours" :font-size="fontSize" />
          <span class="letter">h</span>
          <span class="colon">:</span>
          <scroll-selector ref="scroll-selector-2" :infinite="true" v-model="time.minutes" :options="minutes" :font-size="fontSize" />
          <span class="letter">m</span>
          <span class="colon">:</span>
          <scroll-selector ref="scroll-selector-3" :infinite="true" v-model="time.seconds" :options="seconds" :font-size="fontSize" />
